...
import floatwindow.xishuang.float_lib.util.DensityUtil;
import floatwindow.xishuang.float_lib.util.DeviceUtil;
...
public class DraggableFlagView extends View {
    ...
    public void setOnDraggableFlagViewListener(OnDraggableFlagViewListener onDraggableFlagViewListener) {
        this.onDraggableFlagViewListener = onDraggableFlagViewListener;//拖拽监听器
    }
