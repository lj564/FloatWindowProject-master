...
public class FloatLayout extends FrameLayout {
    ...
    private final GifImageView mFloatView;
    ...
    public GifDrawable walkDrawable;
    ...
    public FloatLayout(Context context, AttributeSet attrs) {
        ...
        bodyView=LayoutInflater.from(context).inflate(R.layout.float_littlemonk_layout, this);
        //浮动窗口按钮
        mFloatView = (GifImageView) bodyView.findViewById(R.id.float_id);
        try {
            walkDrawable=new GifDrawable(context.getAssets(),"sausage_walk.gif");
        } catch (IOException e) {
            e.printStackTrace();
        }
        mFloatView.setImageDrawable(walkDrawable);
   ...
   public GifImageView getmFloatView() {
       return mFloatView;
    }
